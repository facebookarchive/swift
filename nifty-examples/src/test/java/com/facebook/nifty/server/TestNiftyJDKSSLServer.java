...
import com.facebook.nifty.ssl.JDKSSLServerConfiguration;
...
public class TestNiftyJDKSSLServer
{
    private static final Logger log = Logger.get(TestNiftyJDKSSLServer.class);
    ...
    SSLServerConfiguration createSSLServerConfiguration(boolean allowPlaintext, SessionTicketKey[] ticketKeys) {
        return JDKSSLServerConfiguration.newBuilder()

...
public class TProtocolWriter {
  ...
  public void writeBinary(String name, short id, ByteBuffer buf) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.STRING, id));
    protocol.writeBinary(buf);
    protocol.writeFieldEnd();
  }

  public void writeBool(String name, short id, boolean b) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.BOOL, id));
    protocol.writeBool(b);
    protocol.writeFieldEnd();
  }

  public void writeByte(String name, short id, byte b) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.BYTE, id));
    protocol.writeByte(b);
    protocol.writeFieldEnd();
  }

  public void writeDouble(String name, short id, double dub) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.DOUBLE, id));
    protocol.writeDouble(dub);
    protocol.writeFieldEnd();
  }

  public void writeI16(String name, short id, short i16) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.I16, id));
    protocol.writeI16(i16);
    protocol.writeFieldEnd();
  }

  public void writeI32(String name, short id, int i32) throws TException {
    protocol.writeFieldBegin(new TField(name, TType.I32, id));
    protocol.writeI32(i32);
    protocol.writeFieldEnd();
  }

  public void writeI64(String name, short id, long i64) throws TException {

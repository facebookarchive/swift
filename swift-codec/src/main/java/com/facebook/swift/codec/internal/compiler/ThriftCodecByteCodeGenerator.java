...
public class ThriftCodecByteCodeGenerator<T> {
  ...
  private void buildStruct(
      ...
      Map<Short, LocalVariableDefinition> structData
  ) {
   ...
   * variable.
   */
  private LocalVariableDefinition constructInstance(
      MethodDefinition read,
      Map<Short, LocalVariableDefinition> structData
  ) {
  ...
  private void injectFields(
      MethodDefinition read,
      LocalVariableDefinition instance,
      Map<Short, LocalVariableDefinition> structData
  ) {
    for (ThriftFieldMetadata field : metadata.getFields()) {
   ...
   */
  private void invokeFactoryMethod(
      MethodDefinition read,
      Map<Short, LocalVariableDefinition> structData,
      LocalVariableDefinition instance
  ) {
  ...
  private static class ConstructorParameters {
    ...
    public List<NamedParameterDefinition> getParameters() {
      return Lists.transform(
          fields, new Function<FieldDefinition, NamedParameterDefinition>() {
    ...
    public Class<?>[] getTypes() {
      List<Class<?>> types = Lists.transform(
          values, new Function<Object, Class<?>>() {
  ...
  static {
    ...
    try {
      writeBuilder.put(
          BOOL,
          TProtocolWriter.class.getMethod(
              "writeBoolField",
              String.class,
              short.class,
              boolean.class
      ...
      readBuilder.put(
          STRUCT, TProtocolReader.class.getMethod(
          "readStructField",
          ThriftCodec.class
      )
      );

...
public class ThriftEventHandlerChain
{
    final List<ThriftEventHandler> handlers;

    public ThriftEventHandlerChain()
    {
    ...
    public void removeEventHandler(ThriftEventHandler handler)
    {
    ...
    public ContextChain getContextChain(String methodName, RequestContext requestContext)
    {
        return new ContextChain(handlers, methodName, requestContext);
    }
    ...
    public static class ContextChain
    {
        ...
        private ContextChain(List<ThriftEventHandler> handlers, String methodName, RequestContext requestContext)
        {
